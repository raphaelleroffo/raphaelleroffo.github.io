...
This is part 2 of a tutorial in which we're exploring the theme of cycling to school (find part one [here](https://raphaelleroffo.github.io/intro-to-gis/intro-tutorial4.html)). 
...
You can pick up from where you left last week, opening the project file `London`  inside the [Session 4 geopackage](https://github.com/raphaelleroffo/intro-to-gis/raw/main/Session4/Session4-London.gpkg). Make sure the CRS is set to `EPSG:27700` and try to use a basemap of your choice from the `XYZ Tiles` section of your `Browser` panel. I'm using `CartoDb Positron`.

You can download the final geopackage for this session [here](https://github.com/raphaelleroffo/intro-to-gis/raw/main/Session5/Session5-London.gpkg) to have a completed version of this tutorial. 
